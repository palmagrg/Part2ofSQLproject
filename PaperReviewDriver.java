...
private static void getReviewDetails(Connection conn) {
...
private static void getCount(Connection conn) {
...
private static void createNewSubmission(Connection conn) {
...
private static void deleteAuthor(Connection conn) {
    ...
    try {
        ...
        String firstAuthorDeleteSql = "DELETE from author WHERE emailaddress='dolmalama@hotmail.com'";
